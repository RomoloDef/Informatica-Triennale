...
def load_table(filename: str):
    with open(filename, mode = "r", encoding = "utf8") as F:
        parole_prima_riga = []
        righe = F.readlines()
        for parola in righe[0].split():
            parole_prima_riga.append(parola)
        tabella = []
        for riga in righe[1:]:
            valori = riga.split()
            diz = dict(zip(parole_prima_riga, valori))
            tabella.append(diz)
    return tabella           
    pass
...
#check_test(load_table, [{'Nome': "Luigi", "Telefono": '555-871612'},{'Nome': "Mario", "Telefono": '555-826781'}], 'file02.txt')
check_test(load_data, [{'Nome': "Luigi", "Spese": 100},{'Nome': "Mario", "Spese": 1000}], 'file03.txt')
#check_test(load_csv, [{'Nome': "Luigi", "Telefono": None, "Spese": 100, "Tasse": 10},{'Nome': "Mario", "Telefono": '555-1234', "Spese": 1000, "Tasse": None}], 'file04.csv', True)
#check_test(load_csv, [{'Nome': "Luigi", "Spese": 100, "Tasse": 10},{'Nome': "Mario", "Telefono": '555-1234', "Spese": 1000}], 'file04.csv', False)
#check_test(column_stats, {"Spese": 2100, "Tasse": 1011}, 'file05.csv')
