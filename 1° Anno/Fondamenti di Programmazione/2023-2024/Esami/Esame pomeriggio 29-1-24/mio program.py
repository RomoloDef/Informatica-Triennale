...
def func4(input_txt, output_txt):
    with open(input_txt, 'r', encoding = 'utf-8') as file:
        ...
        print(parole_invertite)
        with open(output_txt, 'w', encoding = 'utf-8') as f:
            lista_parole = []
            for parola in parole_invertite:
                if len(parola) > 3:
...
print(func4("/Users/romolodeffereria/Desktop/Corso Python/Esami/Esame pomeriggio 29-1-24/func4/in_example1.txt", "/Users/romolodeffereria/Desktop/Corso Python/Esami/Esame pomeriggio 29-1-24/func4/exp_example1.txt"))
...
def ex2(T):
    # posso fare tutto in una sola funzione
    if T is None:
        return 0, 0, 0
    L1, S1, D1 = ex2(T.left)
