...
of the original string, the second one is the string with the vowels (aeiou) doubled. 
The list of tuples must be sorted in descending order with respect to the length of the string
obtained by doubling the vowels, and in case of equal length, to alphabetical order
(of the original strings).

For example:
L = ['cAsa', 'xyzzY', 'gAtto', 'topO', 'ragno', 'canE', 'tappEto', 'Oca']
result = [(7, 'taappEEtoo'), (5, 'gAAttoo'), (5, 'raagnoo'), (4, 'cAAsaa'), (4, 'caanEE'), (4, 'toopOO'), (3, 'OOcaa'), (5, 'xyzzY')]
'''
def func1(L):
    ## your code goes here
    pass
...
# L = ['cAsa', 'xyzzY', 'gAtto', 'topO', 'ragno', 'canE', 'tappEto', 'Oca']
# print(func1(L)) # [(7, 'taappEEtoo'), (5, 'gAAttoo'), (5, 'raagnoo'), (4, 'cAAsaa'), (4, 'caanEE'), (4, 'toopOO'), (3, 'OOcaa'), (5, 'xyzzY')]
